...
from models.MLCM import build_VLFusion,build_MLCM
...
class MLCMF(nn.Module):
    def __init__(self, bert_model='bert-base-uncased',tunebert=True, args=None):
        ...
        # Visual model
        self.visumodel = build_MLCM(args)
    ...
    def forward(self, image, mask, word_id, word_mask):
        ...
        if not self.tunebert: # fix bert during training
            fl = fl.detach()
        # Multimodal Encoder —— Multi-Level Cross-Modal feature learning module
